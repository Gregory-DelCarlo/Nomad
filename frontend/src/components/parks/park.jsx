    ...
    render() {
        ...
        return(
            ...
            <div className="map-container" >
                ...
                <iframe width="800" height="500" frameborder="0" allowfullscreen src={`https://www.trailforks.com/widgets/region_map/?rid=${this.props.park.rid}&w=800px&h=400px&activitytype=6&maptype=trailforks&trailstyle=difficulty&controls=0&list=1&layers=labels,poi,polygon,directory,region&z=&lat=&lon=&hideunsanctioned=0`}></iframe>
                </div>
            </div>
        )
